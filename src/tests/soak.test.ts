...
const numberOfCrocodilesCreated = new Counter('NumberOfCrocodilesCreated');
const numberOfCrocodilesDeleted = new Counter('NumberOfCrocodilesDeleted');
const numberOfCrocodilesUpdated = new Counter('NumberOfCrocodilesUpdated');
...
const countCrocs = new Map();
const countDeleted = new Map();
const countUpdated = new Map();
